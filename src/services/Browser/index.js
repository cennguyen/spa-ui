...
export const isTablet = () => {
    ...
    if (
        !check &&
        navigator.userAgent &&
        navigator.userAgent.match(/Intel Mac/) &&
...
// TODO refactor the logic and checking with newest devices
/**
 *
 * @returns {'MOBILE'|'TABLET'|'DESKTOP'}
 */
export const checkViewPort = () => {
    // if (isMobile()) return VIEW_PORT.MOBILE
    // if (isTablet()) return VIEW_PORT.TABLET
